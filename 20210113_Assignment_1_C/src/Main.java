...
// Part C (optional) - "Genericizing" Class Sublist
...
public class Main
{
   public static void main(String[] args)
   {
      ...
      Sublist<iTunesEntry> sublist = new Sublist<iTunesEntry>(dataSet);
      ...
      if (TARGET > masterSum)
      {
         ...
         for (int i = 0; i < arraySize; i++)
         {
            sublist = sublist.addItem(i, dataSet.get(i).getTime());
         }
      ...
      else
      {
         ...
         for (int i = 0; i < arraySize; i++)
         {
            ...
            for (int j = 0; j < choicesSize; j++)
            {
               ...
               if (sum <= TARGET)
               {
                  choices.add(sublist.addItem(i, dataSet.get(i).getTime()));
